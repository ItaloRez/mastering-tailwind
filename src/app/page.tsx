  ...
  return (
    <>
      ...
      <div className="mt-6 flex flex-col">
        <div className="flex flex-col justify-between border-b border-zinc-200 pb-5 lg:flex-row lg:items-center dark:border-zinc-700">
          ...
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-3 lg:block">
                ...
                <InputRoot id="lastName">
                  <InputControl defaultValue={'Mariano'} />
                </InputRoot>
              </div>
            </div>
          </div>
